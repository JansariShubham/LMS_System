...
//	@Query("SELECT c.courseId, c.courseName, c.courseDuration, c.courseRating, c.courseStatus, c.coursePrice, c.courseImage, u.firstName, u.profileImage  FROM Course as c INNER JOIN Tutor as t ON (c.tutor_fk = t.tutor_id) INNER JOIN User as u ON (t.user_fk = u.user_id) ")
